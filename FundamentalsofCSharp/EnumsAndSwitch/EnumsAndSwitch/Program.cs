...
namespace EnumsAndSwitch
{
    class Program
    {
        ...
        {
            // Switch statement migth be better for situations with lots of different use cases
            // - more concise than if, else if, else conditionals
            ...
            // Color coding the printed text
            Console.ForegroundColor = ConsoleColor.DarkRed; // ConsoleColor is an enum
        ...
        private static void PrintAssessment(List<Todo> todos)
        {
            ...
            {
                switch (todo.Status) // todo.Status --> then click on lightbulb and add missing cases
                {
                    ...
                    case Status.Deleted:
                        ...
                        break;
                    default: // similar to else, "catch all"
                        break;
                }
    ...
    enum Status // gives more textual/visual feel
    {
        NotStarted, // notice, NotStarted = 0
        InProgress, // InProgress = 1, etc.
        OnHold,
        Completed,
        Deleted
    }
